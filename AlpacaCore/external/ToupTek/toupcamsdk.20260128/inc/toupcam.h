...
#define TOUPCAM_GVCP_TIMEOUT_DEF          30      /* GVCP Timeout */
#define TOUPCAM_GVCP_TIMEOUT_MIN          15
...
/*
    get the version of this dll/so/dylib, which is: 59.30701.20260128
*/
#if defined(_WIN32)
