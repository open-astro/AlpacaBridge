...
> **All four ports come up OFF every time AlpacaBridge connects** — this is unconditional, not configurable. Before this, a port came up however the hardware or your previous session left it, which meant a dew heater or flat panel could still be live at full power after a reboot. Turn on whatever you need from your Alpaca client (e.g. NINA) after connecting.
